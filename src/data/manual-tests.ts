...
export const MANUAL_TESTS: ManualTest[] = [
	...
	},
	{
		...
		steps: [
			"Click the '🖼️' icon.",
			'<b>Expected</b>: A dropdown of pre-made and saved scenes appears.',
			'Select a scene.',
			'<b>Expected</b>: The grid and rules update to the selected scene.',
		],
	...
	},
	{
		...
		steps: [
			"In View Mode, move the 'Speed' slider.",
			'<b>Expected</b>: The rate of generations per second changes when the simulation is playing.',
		],
	...
	},
	{
		...
		steps: [
			"Adjust the 'Survive' and 'Born' sliders.",
			"Toggle the 'Faces', 'Edges', 'Corners' checkboxes.",
			'Step the simulation.',
			'<b>Expected</b>: The next generation is calculated based on the new rules.',
		],
	...
	},
	{
		...
		steps: [
			"In Edit Mode, manually change the X, Y, Z coordinates in the 'Cursor Position' inputs.",
			'<b>Expected</b>: The cursor teleports to the new coordinates.',
		],
	...
	},
	{
		...
		steps: [
			"Go to the 'Camera Controls' section.",
			"Adjust 'Pan Sensitivity' and move the camera. <b>Expected</b>: Camera movement speed changes.",
			"Toggle an 'Invert' checkbox. <b>Expected</b>: The corresponding camera rotation axis is inverted.",
		],
	...
	},
	{
		...
		steps: [
			'Automated test verifies graceful handling of out-of-bounds get requests.',
		],
		claimIds: ['DS-1'],
	},
	{
		...
		steps: [
			'Automated test verifies correct setting and getting of cell states.',
		],
		claimIds: ['DS-1'],
	},
	{
		...
		steps: [
			'Automated test verifies graceful handling of out-of-bounds set requests.',
		],
		claimIds: ['DS-1'],
	},
	{
	...
	},
	{
		...
		steps: [
			'Automated test verifies state is saved and restored without data loss.',
		],
		claimIds: ['DS-1'],
	},
	{
		...
		steps: [
			'Automated test verifies the simulation tick correctly applies rules.',
		],
		claimIds: ['DS-1'],
	},
];
