...
export const ROTATION_KEY_MAP = {
	...
	"back": {
		0: { k: [0, 1, 0], semicolon: [0, -1, 0], o: [1, 0, 0], period: [-1, 0, 0], i: [0, 0, -1], p: [0, 0, 1] },
		90: { k: [1, 0, 0], semicolon: [-1, 0, 0], o: [0, -1, 0], period: [0, 1, 0], i: [0, 0, -1], p: [0, 0, 1] },
		180: { k: [0, -1, 0], semicolon: [0, 1, 0], o: [-1, 0, 0], period: [1, 0, 0], i: [0, 0, -1], p: [0, 0, 1] },
