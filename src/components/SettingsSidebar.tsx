					...
					>
						<div style={{ display: 'flex', gap: '10px' }}>
							<button
								...
								disabled={running}
								title={
									running ? 'Pause simulation to reset' : undefined
								}
							>
								Reset
							</button>
...
function RulesSection() {
	...
	const onlyCorners =
		neighborCorners && !neighborFaces && !neighborEdges;
...
function SceneManagementSection() {
	...
	const [sceneToDelete, setSceneToDelete] = useState<string | null>(
		null,
	);

	const isBuiltIn = sceneToDelete
		? !!DEFAULT_CONFIGS[sceneToDelete]
		: false;
					...
					{showDeleteModal && (
						<div className='modal-overlay'>
							<div className='modal-content'>
								...
								<p>
									Select a scene to remove from your saved collections:
								</p>
								...
								{isBuiltIn && (
									<div className='warning-text'>
										You have selected a pre-installed scene. It will
										reappear the next time you refresh this app.
									</div>
								)}
