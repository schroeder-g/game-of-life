        ...
        <div className="shortcuts-header">
          ...
          <div className="shortcuts-tabs">
            <button
              ...
              style={{ backgroundColor: '#2a2a2a', color: '#fff', ...(activeTab === "view" && { borderBottom: '2px solid #007bff' }) }}
            >
              View Mode
            </button>
            <button
              ...
              style={{ marginLeft: '8px', backgroundColor: '#2a2a2a', color: '#fff', ...(activeTab === "edit" && { borderBottom: '2px solid #007bff' }) }}
            >
              Edit Mode
            </button>
          </div>
