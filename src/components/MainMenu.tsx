          ...
          <section className="menu-section">
            ...
            <label className="control-label">
              ...
              <input
                ...
                onChange={(e) =>
                  props.onCellMarginChange(Number(e.target.value))
                }
              />
            </label>
          </section>
            ...
            <div className="rules-grid">
              ...
              <label className="control-label mini">
                ...
                <input
                  ...
                  onChange={(e) =>
                    props.onBirthMinChange(Number(e.target.value))
                  }
                />
              </label>
              <label className="control-label mini">
                ...
                <input
                  ...
                  onChange={(e) =>
                    props.onBirthMaxChange(Number(e.target.value))
                  }
                />
              </label>
              <label className="control-label mini">
          ...
          <section className="menu-section">
            ...
            <label className="control-label">
              ...
              <select
                ...
                onChange={(e) =>
                  props.onShapeChange(e.target.value as ShapeType)
                }
              >
                {SHAPES.map((shape) => (
            ...
            <label className="control-label">
              ...
              <input
                ...
                onChange={(e) =>
                  props.onShapeSizeChange(Number(e.target.value))
                }
              />
            </label>
      ...
      {collapsed && (
        <div className="floating-actions">
          <button
            className="glass-button primary"
            onClick={props.onPlayStop}
            data-tooltip-bottom={props.running ? "Pause" : "Play"}
          >
            {props.running ? "⏸" : "▶"}
          </button>
          <button
