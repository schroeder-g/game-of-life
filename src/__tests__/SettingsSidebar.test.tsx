...
describe('SettingsSidebar and AppHeaderPanel Integration Tests', () => {
    ...
    const baseSimulationValue = {
        ...
        meta: {
            ...
            gridRef: { current: { getLivingCells: () => [1], on: vi.fn(() => () => { }), generation: 0, version: 0 } },
    ...
    beforeEach(() => {
        ...
        (useBrush as any).mockReturnValue({
            state: { selectedShape: 'Cube', shapeSize: 3, selectorPos: [10, 10, 10], brushQuaternion: { current: {} } },
    ...
    it('[UC-1] should toggle edit/view mode when the mode toggle button is clicked', () => {
        ...
        const toggleButton = screen.getByRole('button', { name: /switch to view mode/i });
